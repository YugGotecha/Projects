...
?> 
  ...
  <link rel="icon"  href="img/Flag_of_India.png">
...
<body style="background-size: cover;
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php" style="margin-top: 5%;"><b>Cyber Portal</b></a>
    </div>
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"><h1 style="color: antiquewhite;">User Id</h1></label>
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Cyber Portal</b></h4>
</div>
